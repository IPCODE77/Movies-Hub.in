        ...
        function preview() {
          ...
          xhr.onload = function () {
            if (this.status == 200) {
              ...
              display_content.innerHTML = `<i class="fa-solid fa-circle-arrow-left" id="backicon" style="color:yellow;color: yellow;font-size: 25px;margin: 10px 0px;" onclick="window.location.href='/movie.html'"></i>
